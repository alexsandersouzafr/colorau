...
const pageSections = [
  { href: "#material-de-apoio", label: "Partituras e Áudios", icon: true },
  { href: "#avisos", label: "Avisos" },
  { href: "#agenda", label: "Agenda" },
  { href: "#ensaios", label: "Ensaios" },
  { href: "#manifesto-cultura", label: "Manifesto e Cultura" },
  { href: "#documentos-importantes", label: "Documentos importantes" },
];
      ...
      <section className="container-width flex flex-col gap-8 md:gap-10">
        <Reveal className="section-card p-0">
          <div className="grid grid-cols-1 md:grid-cols-[140px_1fr]">
            ...
            <div className="px-6 py-7 md:px-10 md:py-10">
              ...
              <div>
                <nav
                  aria-label="Índice da página do corista"
                ...
                >
                  {pageSections.map((section) => (
                    <a
                      key={section.href}
                      href={section.href}
                      className="inline-flex items-center gap-2 border border-black/10 bg-black/5 px-3 py-2 text-xs text-black/70 transition hover:border-accent hover:bg-accent hover:text-accent-foreground md:px-4 md:text-sm"
                    >
                      {section.icon ? <Music className="h-3.5 w-3.5 shrink-0" /> : null}
                      {section.label}
                    </a>
                  ))}
                </nav>
        ...
        <section id="avisos" className="scroll-mt-24">
          <Reveal className="section-card section-inverse border border-accent/20 space-y-6">
            <div>
              <h2 className="font-semibold text-accent mb-2">Avisos</h2>
              <p className="text-white/80">
                Informes importantes para o andamento da temporada e da agenda do grupo.
              </p>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-10">
          <section id="ensaios" className="scroll-mt-24">
            <Reveal className="section-card bg-black/5 h-full">
        ...
        <section id="material-de-apoio" className="scroll-mt-24">
          <Reveal className="section-card section-inverse">
            <h2 className="text-2xl font-semibold text-accent">Partituras e Áudios</h2>
        ...
        <section id="manifesto-cultura" className="scroll-mt-24">
        ...
        <section id="documentos-importantes" className="scroll-mt-24">
